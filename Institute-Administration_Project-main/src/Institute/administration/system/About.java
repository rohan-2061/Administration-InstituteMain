...
public class About extends JFrame {
    About(){
        ...
        JLabel heading = new JLabel("<html>SVERI<br> College Of Egineering </html>");
        heading.setBounds(70,20,300,130);
        heading.setFont(new Font("Tahoma", Font.BOLD,30));
        add(heading);

        JLabel name = new JLabel("Chavan B.V. & Jadhav B.T.");
        name.setBounds(60,260,550,40);
        name.setFont(new Font("Tahoma", Font.BOLD,30));
        add(name);

        JLabel contact = new JLabel("chavanbramhdev13@gmail.com");
